...
| `/stats [멤버]` | 멤버 통계(서버 입·퇴장 횟수, 누적 음성 체류시간, 최근 활동, **경고**) | 누구나 |
...
> 위 슬래시 명령은 영어 이름(`/ping`, `/channels`, `/welcome-channel`, `/dormant set·clear`, `/warn` 등)으로도 제공됩니다.
...
│   └── moderation.py   # /유저경고(warn) — 경고 추가 (목록은 /스탯)
└── docs/
